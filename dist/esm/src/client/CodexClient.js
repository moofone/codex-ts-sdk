...
import { createAddToHistorySubmission, createCompactSubmission, createExecApprovalSubmission, createGetHistoryEntryRequestSubmission, createGetPathSubmission, createInterruptSubmission, createListCustomPromptsSubmission, createListMcpToolsSubmission, createOverrideTurnContextSubmission, createPatchApprovalSubmission, createReviewSubmission, createShutdownSubmission, createStatusSubmission, createUserInputSubmission, createUserTurnSubmission, } from '../internal/submissions';
import { StatusStore } from '../internal/StatusStore';
import { loadNativeModule, formatOverrides, } from '../internal/nativeModule';
...
export class CodexClient extends EventEmitter {
    ...
    async sendUserTurn(text, options = {}) {
        ...
        const resolved = resolveModelVariant(options.model ?? this.config.defaultModel ?? DEFAULT_MODEL, options.effort ?? this.config.defaultEffort);
