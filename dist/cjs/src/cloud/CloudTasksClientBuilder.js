...
exports.CloudTasksClientBuilder = void 0;
const CloudTasksClient_1 = require("./CloudTasksClient");
/**
...
class CloudTasksClientBuilder {
    ...
    build() {
        ...
        return new CloudTasksClient_1.CloudTasksClient({
            ...this.options,
            baseUrl,
            mock,
        });
...
exports.CloudTasksClientBuilder = CloudTasksClientBuilder;
