...
exports.toTaskText = exports.toTurnAttempt = exports.toApplyOutcome = exports.toTaskSummary = exports.toAttemptStatus = void 0;
...
function toAttemptStatus(value) {
    switch (value) {
        case 'pending':
        case 'completed':
        case 'failed':
...
exports.toAttemptStatus = toAttemptStatus;
function toTaskSummary(n) {
...
exports.toApplyOutcome = toApplyOutcome;
function toTurnAttempt(n) {
    const turnId = pick(n, 'turnId', 'turn_id');
...
exports.toTurnAttempt = toTurnAttempt;
function toTaskText(n) {
    const messages = pick(n, 'messages') ?? [];
    const turnId = pick(n, 'turnId', 'turn_id');
    const siblingTurnIds = pick(n, 'siblingTurnIds', 'sibling_turn_ids') ?? [];
    const attemptPlacement = pick(n, 'attemptPlacement', 'attempt_placement');
